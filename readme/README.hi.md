...
- प्लगइन द्वारा जारी कनेक्शन पैक (wp-admin → कार्य प्रबंधन → प्राधिकरण, या `wp wptsall security issue-pairing-pack`)
...
## त्वरित शुरुआत
1. अपनी साइट जोड़ें — wp-admin (कार्य प्रबंधन → प्राधिकरण) में कनेक्शन पैक बनाएँ और पेयरिंग कोड के साथ क्लाइंट के साइट्स पेज पर पेस्ट करें
